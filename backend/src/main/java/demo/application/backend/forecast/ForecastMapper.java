package demo.application.backend.forecast;
...
public interface ForecastMapper {
    ...
    CurrentStatus map(ApiCurrentStatus apiCurrentStatus);
    ...
    DayStatus map(ApiDayStatus.DayStatusItem dayStatusItem);

    List<DayStatus> map(List<ApiDayStatus.DayStatusItem> list);
